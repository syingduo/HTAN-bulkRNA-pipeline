...
```{r}
edb = EnsDb(here('upstream_sources/EnsDb.Hsapiens.v102.sqlite'))

gencode_txdb = makeTxDbFromGFF(
    here('upstream_sources/gencode.v36.annotation.gtf.gz'),
    format = 'gtf',
...
```{r}
gene_info_tbl %>% 
    write_tsv(here('final_outputs/gencode.gene.info.v36.tsv.gz'))
```
